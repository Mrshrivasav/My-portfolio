	...
	const educationData = [
		{
			...
			duration: "Aug 2023 - Sep 2026",
			degree: "BCA with (Aiml and Machine Learning)",
			grade: "CGPA: 7.0 (70%)",
			...
			description: "During my time at BCA with AIML and Machine Learning, I have built a strong foundation in computer science, focusing on software development, problem-solving, and real-world applications. Engaging in hands-on projects, internships, and coding challenges has helped me enhance my technical and analytical skills. This experience prepares me for a future in software development, equipping me with the ability to create scalable and efficient solutions."
		},
		{
			school: "HS DAV Public School",
