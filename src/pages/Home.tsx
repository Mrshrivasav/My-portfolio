...
const Home = () => {
	...
	const email = 'amanshriwastava0@gmail.com';
	const whatsappNumber = '+9905035452';

	const { data: githubData } = useSWR('https://github.com/Mrshrivasav', fetcher);
		...
		<div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
			<div className="text-center relative z-10 max-w-4xl mx-auto">
				...
				<motion.h1
					...
					transition={{ duration: 0.8 }}
				>
					I design code with web and app integrate ai & machine learning 				</motion.h1>
				...
				>
					Software Developer specializing in Full Stack Development expertise in Next.js, Node.js with Data Science and machine learning getting hold on Ai workflows with agentic ai
				</motion.p>
